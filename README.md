...
5.
Local Testing in Mock Mode Always validate your setup locally before initiating a server run. Ensure your terminal is currently inside the 2026_multiomnicpipeline/trial directory.
...
6. Server Execution in Production Mode
